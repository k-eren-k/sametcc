...
const CVPage = () => {
  ...
  useEffect(() => {
    ...
    // Mobil cihazlarda canvas boyutunu daha küçük ayarla
    canvas.width = window.innerWidth;
    canvas.height = window.innerHeight;

    const particles: Particle[] = [];
    const particleCount = window.innerWidth < 768 ? 50 : 150; // Mobilde daha az partikül
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.size = window.innerWidth < 768 ? Math.random() * 1 + 0.1 : Math.random() * 2 + 0.1; // Mobilde daha küçük partiküller
      ...
      update() {
        ...
        // Partiküller ekranın dışına çıkarsa diğer taraftan girmesini sağla
  ...
  const projects = [
    {
      ...
      description: "GitHub Profile Viewer, geliştiricilerin GitHub profillerini detaylı bir şekilde inceleyebilmeleri ve açık kaynak katkıları hakkında değerli bilgiler elde edebilmeleri için tasarlanmış bir web uygulamasıdır.",
      technologies: "React.js, Next.js, C#, .NET 8, Blazor, Azure, Github REST API",
      link: "https://sametcc.me/github-profile-viewer"
    },
    {
      title: "Electron Widgets",
      description: "Electron.js kullanılarak geliştirilmiş bir cross platform masaüstü uygulaması. Kullanıcıların HTML/CSS ve JavaScript kullanarak kendi masaüstü widget'larını oluşturmalarına ve düzenlemelerine olanak tanır.",
      technologies: "Electron.JS, Vue.JS",
      link: "https://sametcc.me/electron-widgets"
    },
    {
      title: "Code Nest",
      description: "Github Gists alternatifi olarak, geliştiricilerin projelerini paylaşabileceği ve keşfedebileceği bir platform.",
      technologies: "Next.JS, Supabase, PostgreSQL",
      link: "https://sametcc.me/code-nest-web"
    },
    {
      title: "Resume Builder",
      description: "Kullanıcıların özgeçmişlerini oluşturmalarına ve yönetmelerine olanak tanıyan bir masaüstü uygulaması.",
      technologies: "C#, .NET, MSSQL",
      link: "https://sametcc.me/resumebuilder"
    },
    {
      title: "Reddit RSS API",
      description: "Reddit'in RSS feed özelliğinin bir REST API gibi kullanılabilmesini sağlayan bir API projesi.",
      technologies: "TypeScript, Deno",
      link: "https://sametcc.me/reddit-rss-api"
    }
  ];
