...
        <title>Samet Can Cıncık CV</title>

        <meta name="description" content="Sitemiz hakkında bilgiler." /> {/* İsteğe bağlı meta açıklaması */}

      <canvas ref={canvasRef} className="absolute inset-0 h-full w-full" />

      <div ref={contentRef} className={`relative z-10 container w-[1120px] mx-auto px-4 py-12 ${poppins.className} text-white`}>
